    ...
    */
    ...
    typedef struct
    {
        ...
        */
        gxObject base;
        dlmsVARIANT value;
		unsigned char* (*read_api)(int* len);
    ...
    typedef struct
    {
        ...
        * Base class where class is derived.
        */
        gxObject base;                   //Attribute 1

        DLMS_CLOCK_BASE clockBase: 8;     //Attribute 9
        signed char deviation;            //Attribute 7
        unsigned char enabled;            //Attribute 8
        gxtime end;                       //Attribute 6
        DLMS_CLOCK_STATUS status : 8;     //Attribute 4
        gxtime begin;                     //Attribute 5
        int16_t timeZone;                 //Attribute 3
        gxtime time;                      //Attribute 2
        gxtime presetTime;
    } gxClock;
