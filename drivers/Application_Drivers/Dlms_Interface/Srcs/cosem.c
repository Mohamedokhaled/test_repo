...
#endif
#include <string.h>
#include "../Includes/datainfo.h"
#include "../Includes/dlms.h"
#include "../Includes/cosem.h"
#include "../Includes/helpers.h"
#include "../Includes/lnparameters.h"
#ifndef DLMS_IGNORE_ASSOCIATION_SHORT_NAME
#include "../Includes/snparameters.h"
    ...
    const unsigned char* ln)
{
    ...
    case DLMS_OBJECT_TYPE_ASSOCIATION_LOGICAL_NAME:
    {
      ...
      /*   it->serverSAP = 0x91;  Todo Sara Modification
		it->clientSAP = 0x64; */
    }
    break;
#endif /* DLMS_IGNORE_ASSOCIATION_LOGICAL_NAME */
...
int cosem_setDateTimeAsOctetString(gxByteBuffer* bb, gxtime* value)
{
	...
	rtc_get_time(RTC , (uint32_t*)&hour, (uint32_t*)&minute, (uint32_t*)&second);
	rtc_get_date(RTC , (uint32_t*)&year, (uint32_t*)&month,  (uint32_t*)&day, (uint32_t*)&dayOfWeek); */
	/*
	...
	*/
	...
	if ((ret = bb_setUInt8(bb, DLMS_DATA_TYPE_OCTET_STRING)) != 0 ||
	    ...
	    (ret = bb_setUInt16(bb,value->value.tm_year)) != 0 ||
	    (ret = bb_setUInt8(bb, value->value.tm_mon)) != 0 ||
	    (ret = bb_setUInt8(bb, value->value.tm_mday)) != 0 ||
	    (ret = bb_setUInt8(bb, value->value.tm_wday)) != 0 ||
	    (ret = bb_setUInt8(bb, value->value.tm_hour)) != 0 ||
	    (ret = bb_setUInt8(bb, value->value.tm_min)) != 0 ||
	    (ret = bb_setUInt8(bb, value->value.tm_sec)) != 0 ||
...
/*TODO : it add 1900 to the year as debug*/
/*      if ((ret = bb_setUInt8(bb, DLMS_DATA_TYPE_OCTET_STRING)) != 0 ||
         (ret = bb_setUInt8(bb, 12)) != 0 ||
